...
public class DCT1Test {
    ...
    public void testTwoDDCT() {
        ...
        DCT1 dct1 = new DCT1();
        int[][] checkerboardDCT = DCT.toInt(dct1.twoDDCT(checkerboard));
    ...
    public void testTwoDDCT2() {
        ...
        DCT1 dct1 = new DCT1();
        int[][] checkerboardDCT = DCT.toInt(dct1.twoDDCT(randomValues));
    ...
    public void testInverseTwoDDCT() {
        ...
        DCT1 dct1 = new DCT1();
        int[][] checkerboardDCT = DCT.toInt(dct1.inverseTwoDDCT(checkerboardResult));
    ...
    public void testInverseTwoDDCT2() {
        ...
        DCT1 dct1 = new DCT1();
        int[][] checkerboardDCT = DCT.toInt(dct1.inverseTwoDDCT(randomValuesResult));
    ...
    void performanceDctTestWithMultithreading() {
        ...
        dct1.calculateOnePictureDataWithDCT(jpegEncoderImage);
