...
public class DCT2Test {
    ...
    public void testTwoDDCT2() {
        ...
        DCT2 dct2 = new DCT2();
        double[][] checkerboardDCT = dct2.twoDDCT(randomValues);
    ...
    public void testInverseTwoDDCT() {
        ...
        DCT2 dct2 = new DCT2();
        double[][] checkerboardDCT = dct2.inverseTwoDDCT(checkerboardResult);
    ...
    public void testInverseTwoDDCT2() {
        ...
        DCT2 dct2 = new DCT2();
        double[][] checkerboardDCT = dct2.inverseTwoDDCT(randomValuesResult);
